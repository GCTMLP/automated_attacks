...
def exploit(msf_rpc_client_password, rhosts, lhosts, lport, mimikatz_directory):
...
def main():
	...
	mimikatz_directory = input("enter mimikatz directory on your computer (Ex: home/user/mimikatz): ")
	passwords = exploit(msf_rpc_client_password, rhosts, lhosts, lport, mimikatz_directory)
